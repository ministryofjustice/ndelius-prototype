...
import { SentencePlanComponent } from './sentence-plan.component';
...
describe('PAROM1 - Component: Current sentence plan and response', () => {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SentencePlanComponent);
  ...
  it('should navigate to the Court details page', () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['parom1/mappa']);
  });
