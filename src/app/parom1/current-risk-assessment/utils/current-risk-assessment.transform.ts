        ...
        table: {
          ...
          body: [
            ...
            [{
              text: 'OGRS3 (year 2)',
              style: 'fontBold'
            }, getString([50, 75, 90], getPercentage(data.ogrs3Percentage), data.ogrs3Percentage)],
            [{
              text: 'OGP (year 2)',
              style: 'fontBold'
            }, getString([34, 67, 85], getPercentage(data.ogpProbability), data.ogpProbability)],
            [{
              text: 'OVP (year 2)',
              style: 'fontBold'
            }, getString([30, 60, 80], getPercentage(data.ovpProbability), data.ovpProbability)],
