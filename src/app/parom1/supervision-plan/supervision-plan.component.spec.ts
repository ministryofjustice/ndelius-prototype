...
import { SupervisionPlanComponent } from './supervision-plan.component';
...
describe('PAROM1 - Component: Supervision plan for release', () => {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SupervisionPlanComponent);
  ...
  it('should render the template', () => {
    expect(compiled.querySelector('h1').innerHTML).toBe('Supervision plan for release');
  });
  ...
  it('should navigate to the Court details page', () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['parom1/recommendation']);
  });
