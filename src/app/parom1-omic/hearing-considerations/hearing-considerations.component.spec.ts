...
import { HearingConsiderationsComponent } from './hearing-considerations.component';
...
describe('PAROM1-OMIC - Component: Oral hearing considerations', () => {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HearingConsiderationsComponent);
  ...
  it('should navigate to the Court details page', () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['parom1-omic/sources']);
  });
