...
import { RiskCommunityComponent } from './risk-community.component';
...
describe('PAROM1-OMIC - Component: Risk within the community', () => {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RiskCommunityComponent);
  ...
  it('should navigate to the Court details page', () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['parom1-omic/risk-custody']);
  });
