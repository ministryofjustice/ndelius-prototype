...
describe('PAROM1-OMIC - Component: Your recommendation (COM)', () => {

  let fixture: ComponentFixture<ComRecommendationComponent>;
  let component: ComRecommendationComponent;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ComRecommendationComponent);
  ...
  it('should navigate to the Court details page', () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['parom1-omic/hearing-considerations']);
  });
